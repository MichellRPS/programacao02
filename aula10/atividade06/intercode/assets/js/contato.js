// evento 03
$('#flip_endereco').click(function() {
    $('#panel_endereco').slideToggle('slow');
});
$('#flip_emails').click(function() {
    $('#panel_emails').slideToggle('slow');
});
$('#flip_telefone').click(function() {
    $('#panel_telefone').slideToggle('slow');
});
$('#flip_mensagem').click(function() {
    $('#panel_mensagem').slideToggle('slow');
});
// evento 03 - fim
